...
$uncode_index_params_first = array(
	...
	array(
		...
		"param_name" => "infinite",
		"description" => wp_kses(__("Activate this to load more items with scrolling.<br>N.B. This option doesn't work is combination with the 'Random' order or with multiple isotope in the same page.", 'uncode'), array( 'br' => array( ) ) ) ,
		"value" => Array(
			esc_html__("Yes, please", 'uncode') => 'yes'
		) ,
		"group" => esc_html__("Module", 'uncode') ,
